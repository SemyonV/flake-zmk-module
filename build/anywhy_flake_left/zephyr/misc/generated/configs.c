...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BLE_EXPERIMENTAL_SEC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BLE_EXPERIMENTAL_FEATURES, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BLE_PASSKEY_ENTRY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_PM_SOFT_OFF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_SOFT_OFF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_TRI_STATE_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_HELPERS_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_AUTO_LAYER_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_LEADER_MAX_KEYS_PER_SEQUENCE, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_LEADER_MAX_SEQUENCES, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_LEADER_KEY_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_TRI_STATE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_TRI_STATE_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_UNICODE_TAP_MS, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_UNICODE_WAIT_MS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_UNICODE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_ANYWHY_FLAKE_LEFT, 1);
